...
module Foaas
  class Client
    ...
    METHODS_ONE_PARAM = [:awesome, :because, :bucket, :bye, :cool, :diabetes, :everyone, :everything, :family, :fascinating, :flying, :give, :life, :looking, :me, :mornin, :pink, :retard, :thanks, :this, :tucker, :thumbs,:what, :zayn, :zero]
    METHODS_TWO_PARAMS = [:back, :bday, :bm, :bus, :caniuse, :chainsaw, :dalton, :donut, :greed, :gfy, :keep, :keepcalm, :king, :linus, :look, :madison, :no, :nugget, :off, :outside, :shakespeare, :shutup, :single,:think, :you, :xmas, :yoda]
