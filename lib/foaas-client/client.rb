...
module Foaas
  class Client
    ...
    METHODS_ONE_PARAM = [:this, :everything, :everyone, :pink, :life, :thanks, :flying, :fascinating, :cool, :what]
    METHODS_TWO_PARAMS = [:off, :you, :donut, :shakespeare, :linus, :king, :chainsaw, :outside, :madison, :nugget, :yoda]
