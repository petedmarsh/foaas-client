...
module Foaas
  class Client
    ...
    METHODS_TWO_PARAMS = [:back, :bday, :bm, :bus, :caniuse, :chainsaw, :dalton, :donut, :greed, :gfy, :keepcalm, :king, :linus, :madison, :nugget, :off, :outside, :shakespeare, :shutup, :think, :you, :xmas, :yoda]
