...
module Foaas
  class Client
    ...
    METHODS_ONE_PARAM = [:awesome, :because, :bucket, :bye, :cool, :diabetes, :everyone, :everything, :family, :fascinating, :flying, :give, :life, :looking, :me, :mornin, :pink, :retard, :thanks, :this, :tucker, :thumbs,:what, :zayn]
